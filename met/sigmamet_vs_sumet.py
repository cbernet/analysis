...
sumetresponse_pf.format(pf_style, 'gen #SigmaE_{T} (GeV)')
...
sumetresponse_calo.format(traditional_style, 'gen #SigmaE_{T} (GeV)')
...
metcalo.format(traditional_style, 'gen #SigmaE_{T} (GeV)')
...
metpf.format(pf_style, 'gen #SigmaE_{T} (GeV)')
